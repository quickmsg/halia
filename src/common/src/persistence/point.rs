...
pub async fn insert(
    ...
    super::insert(get_file(device_id, group_id), point_id, data).await
}
...
pub async fn delete(device_id: &Uuid, group_id: &Uuid, point_id: &Uuid) -> Result<(), io::Error> {
    super::delete(get_file(device_id, group_id), point_id).await
}

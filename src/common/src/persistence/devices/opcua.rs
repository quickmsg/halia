...
fn get_variable_file_path(device_id: &Uuid) -> PathBuf {
    get_device_dir()
...
pub async fn create(device_id: &Uuid, r#type: &'static str, data: String) -> Result<(), io::Error> {
    ...
    crate::persistence::create_file(get_variable_file_path(device_id)).await?;
...
pub async fn create_variable(
    ...
    persistence::create(get_variable_file_path(device_id), variable_id, &data).await
}

pub async fn read_variables(device_id: &Uuid) -> Result<Vec<String>, io::Error> {
    persistence::read(get_variable_file_path(device_id)).await
}
...
pub async fn update_variable(
    ...
    persistence::update(get_variable_file_path(device_id), variable_id, &data).await
}

pub async fn delete_variable(device_id: &Uuid, variable_id: &Uuid) -> Result<(), io::Error> {
    persistence::delete(get_variable_file_path(device_id), variable_id).await
}
